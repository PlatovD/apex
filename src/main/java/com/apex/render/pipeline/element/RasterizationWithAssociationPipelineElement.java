...
@AutoCreation(name = "RasterizationWithAssociationPipelineElement")
public class RasterizationWithAssociationPipelineElement implements PipelineElement {
    @AutoInject
    ...
    public void apply(RenderObject ro) {
        VertexAttributeExtended vertex0Attribute = new VertexAttributeExtended();
        VertexAttributeExtended vertex1Attribute = new VertexAttributeExtended();
        VertexAttributeExtended vertex2Attribute = new VertexAttributeExtended();
        ...
        for (Polygon polygon : ro.getModel().polygons) {
            ...
            // то самое отличие от просто Rasterization element
            {
                ...
                vertex0Attribute.polygonIndex = polygonIndex;
                vertex1Attribute.polygonIndex = polygonIndex;
                vertex2Attribute.polygonIndex = polygonIndex;
            ...
            Rasterization.drawTriangleWithAssociations(rb, zBuffer, associationBuffer,
