...
public abstract class AbstractController implements Controller {
    ...
    @AutoInject
    protected com.apex.storage.CameraStorage cameraStorage;
    ...
    public void handleCameraForward(ActionEvent actionEvent) {
        cameraStorage.getActiveCamera().movePosition(new Vector3f(0, 0, -Constants.TRANSLATION));
        refreshRender();
    }
    ...
    public void handleCameraLeft(ActionEvent actionEvent) {
        cameraStorage.getActiveCamera().movePosition(new Vector3f(Constants.TRANSLATION, 0, 0));
        refreshRender();
    }
    ...
    public void handleCameraUp(ActionEvent actionEvent) {
        cameraStorage.getActiveCamera().movePosition(new Vector3f(0, Constants.TRANSLATION, 0));
        refreshRender();
    }
